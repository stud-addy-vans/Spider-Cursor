...
const earthCursor = document.getElementById("earth-cursor");
...
for (let i = 0; i < 200; i++) {
    stars.push({
        ...
        size: random() * 2 + 1,
        color: `rgb(${random() * 100 + 155}, ${random() * 100 + 155}, ${random() * 100 + 155})`,
    });
}
...
addEventListener("pointermove", (e) => {
    ...
    earthCursor.style.left = cursorX + "px";
    earthCursor.style.top = cursorY + "px";
});
...
requestAnimationFrame(function anim(t) {
    ...
    earthImage.style.transform = `translate(-50%, -50%) rotate(${rotationAngle}rad)`;
